...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.requirementnet.com/peers/peer0.org1.requirementnet.com/msp --csr.hosts peer0.org1.requirementnet.com --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
  set +x
...
echo
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.requirementnet.com/peers/peer1.org1.requirementnet.com/msp --csr.hosts peer1.org1.requirementnet.com --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.requirementnet.com/peers/peer1.org1.requirementnet.com/tls --enrollment.profile tls --csr.hosts peer1.org1.requirementnet.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:7054 --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.requirementnet.com/users/User1@org1.requirementnet.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://org1admin:org1adminpw@localhost:7054 --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.requirementnet.com/users/Admin@org1.requirementnet.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
  set +x
...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8054 --caname ca-org2 -M ${PWD}/organizations/peerOrganizations/org2.requirementnet.com/peers/peer0.org2.requirementnet.com/msp --csr.hosts peer0.org2.requirementnet.com --tls.certfiles ${PWD}/organizations/fabric-ca/org2/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8054 --caname ca-org2 -M ${PWD}/organizations/peerOrganizations/org2.requirementnet.com/peers/peer0.org2.requirementnet.com/tls --enrollment.profile tls --csr.hosts peer0.org2.requirementnet.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/org2/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8054 --caname ca-org2 -M ${PWD}/organizations/peerOrganizations/org2.requirementnet.com/peers/peer1.org2.requirementnet.com/msp --csr.hosts peer1.org2.requirementnet.com --tls.certfiles ${PWD}/organizations/fabric-ca/org2/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8054 --caname ca-org2 -M ${PWD}/organizations/peerOrganizations/org2.requirementnet.com/peers/peer1.org2.requirementnet.com/tls --enrollment.profile tls --csr.hosts peer1.org2.requirementnet.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/org2/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:8054 --caname ca-org2 -M ${PWD}/organizations/peerOrganizations/org2.requirementnet.com/users/User1@org2.requirementnet.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org2/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://org2admin:org2adminpw@localhost:8054 --caname ca-org2 -M ${PWD}/organizations/peerOrganizations/org2.requirementnet.com/users/Admin@org2.requirementnet.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org2/tls-cert.pem
  set +x
...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:4054 --caname ca-org3 -M ${PWD}/organizations/peerOrganizations/org3.requirementnet.com/peers/peer0.org3.requirementnet.com/msp --csr.hosts peer0.org3.requirementnet.com --tls.certfiles ${PWD}/organizations/fabric-ca/org3/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:4054 --caname ca-org3 -M ${PWD}/organizations/peerOrganizations/org3.requirementnet.com/peers/peer0.org3.requirementnet.com/tls --enrollment.profile tls --csr.hosts peer0.org3.requirementnet.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/org3/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer1:peer1pw@localhost:4054 --caname ca-org3 -M ${PWD}/organizations/peerOrganizations/org3.requirementnet.com/peers/peer1.org3.requirementnet.com/msp --csr.hosts peer1.org3.requirementnet.com --tls.certfiles ${PWD}/organizations/fabric-ca/org3/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:4054 --caname ca-org3 -M ${PWD}/organizations/peerOrganizations/org3.requirementnet.com/peers/peer1.org3.requirementnet.com/tls --enrollment.profile tls --csr.hosts peer1.org3.requirementnet.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/org3/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:4054 --caname ca-org3 -M ${PWD}/organizations/peerOrganizations/org3.requirementnet.com/users/User1@org3.requirementnet.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org3/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://org2admin:org2adminpw@localhost:4054 --caname ca-org3 -M ${PWD}/organizations/peerOrganizations/org3.requirementnet.com/users/Admin@org3.requirementnet.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org3/tls-cert.pem
  set +x
...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:5054 --caname ca-org4 -M ${PWD}/organizations/peerOrganizations/org4.requirementnet.com/peers/peer0.org4.requirementnet.com/msp --csr.hosts peer0.org4.requirementnet.com --tls.certfiles ${PWD}/organizations/fabric-ca/org4/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:5054 --caname ca-org4 -M ${PWD}/organizations/peerOrganizations/org4.requirementnet.com/peers/peer0.org4.requirementnet.com/tls --enrollment.profile tls --csr.hosts peer0.org4.requirementnet.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/org4/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer1:peer1pw@localhost:5054 --caname ca-org4 -M ${PWD}/organizations/peerOrganizations/org4.requirementnet.com/peers/peer1.org4.requirementnet.com/msp --csr.hosts peer1.org4.requirementnet.com --tls.certfiles ${PWD}/organizations/fabric-ca/org4/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:5054 --caname ca-org4 -M ${PWD}/organizations/peerOrganizations/org4.requirementnet.com/peers/peer1.org4.requirementnet.com/tls --enrollment.profile tls --csr.hosts peer1.org4.requirementnet.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/org4/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:5054 --caname ca-org4 -M ${PWD}/organizations/peerOrganizations/org4.requirementnet.com/users/User1@org4.requirementnet.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org4/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://org2admin:org2adminpw@localhost:5054 --caname ca-org4 -M ${PWD}/organizations/peerOrganizations/org4.requirementnet.com/users/Admin@org4.requirementnet.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org4/tls-cert.pem
  set +x
...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:6054 --caname ca-org5 -M ${PWD}/organizations/peerOrganizations/org5.requirementnet.com/peers/peer0.org5.requirementnet.com/msp --csr.hosts peer0.org5.requirementnet.com --tls.certfiles ${PWD}/organizations/fabric-ca/org5/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:6054 --caname ca-org5 -M ${PWD}/organizations/peerOrganizations/org5.requirementnet.com/peers/peer0.org5.requirementnet.com/tls --enrollment.profile tls --csr.hosts peer0.org5.requirementnet.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/org5/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer1:peer1pw@localhost:6054 --caname ca-org5 -M ${PWD}/organizations/peerOrganizations/org5.requirementnet.com/peers/peer1.org5.requirementnet.com/msp --csr.hosts peer1.org5.requirementnet.com --tls.certfiles ${PWD}/organizations/fabric-ca/org5/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:6054 --caname ca-org5 -M ${PWD}/organizations/peerOrganizations/org5.requirementnet.com/peers/peer1.org5.requirementnet.com/tls --enrollment.profile tls --csr.hosts peer1.org5.requirementnet.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/org5/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:6054 --caname ca-org5 -M ${PWD}/organizations/peerOrganizations/org5.requirementnet.com/users/User1@org5.requirementnet.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org5/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://org2admin:org2adminpw@localhost:6054 --caname ca-org5 -M ${PWD}/organizations/peerOrganizations/org5.requirementnet.com/users/Admin@org5.requirementnet.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org5/tls-cert.pem
  set +x
...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/requirementnet.com/orderers/orderer.requirementnet.com/msp --csr.hosts orderer.requirementnet.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/requirementnet.com/orderers/orderer.requirementnet.com/tls --enrollment.profile tls --csr.hosts orderer.requirementnet.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/requirementnet.com/users/Admin@requirementnet.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  set +x
